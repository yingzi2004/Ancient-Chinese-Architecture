...
           {
                // 刷新贴图
               pieces[i].SetPiece(currentGarden.texture, x, y, pieceWidth,
pieceHeight);
                
                // 【核心】从数据中读取并恢复角度
                float savedAngle =
currentGarden.savedRotations[i];
...
               gardens[currentIndex].savedRotations[i] =
pieces[i].transform.localEulerAngles.z;
           }
       }
    }
 
